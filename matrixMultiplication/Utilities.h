...
public:
    ...
    void display_flattened_two_dee_array(int * arr, int m, int n);
    ...
    void write_two_dee_integer_array_to_file(const char * filename, int ** arr, int m, int n);
    void write_flattened_two_dee_integer_array_to_file(const char * filename, int * arr, int m, int n);
};
